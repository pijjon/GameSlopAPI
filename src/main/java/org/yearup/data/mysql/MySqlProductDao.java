...
public class MySqlProductDao extends MySqlDaoBase implements ProductDao {
    ...
    public List<Product> search(Integer categoryId, BigDecimal minPrice, BigDecimal maxPrice, String subCategory) {
        ...
        // added a section to account for both min and max price
    ...
    // method for listing products by category
    @Override
    ...
    // method for listing products by product id
    @Override
    ...
    // method for creating new Products and adding them to DB
    @Override
